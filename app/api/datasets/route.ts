...
const DATASET_REGISTRY: Record<string, Partial<Dataset>> = {
  ...
  chennai_flood_hazard_zones_gcc: { id: 'chennai_flood_hazard_zones_gcc', name: 'GCC Flood Hazard Zones — High/Moderate/Low 38 MiB KML (OpenCity)', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  chennai_inundation_depth_inches: { id: 'chennai_inundation_depth_inches', name: 'Inundation Points Depth Inches — GCC (OpenCity)', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  chennai_flow_5yr_return: { id: 'chennai_flow_5yr_return', name: 'Flows 5-yr Return Period — GCC Hazard', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  chennai_flow_10yr_return: { id: 'chennai_flow_10yr_return', name: 'Flows 10-yr Return Period — GCC', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  chennai_flow_25yr_return: { id: 'chennai_flow_25yr_return', name: 'Flows 25-yr Return Period — GCC', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  chennai_flow_50yr_return: { id: 'chennai_flow_50yr_return', name: 'Flows 50-yr Return Period — GCC', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  chennai_flow_100yr_return: { id: 'chennai_flow_100yr_return', name: 'Flows 100-yr Return Period — GCC', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  chennai_flow_200yr_return: { id: 'chennai_flow_200yr_return', name: 'Flows 200-yr Return Period — GCC', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  chennai_flood_monitor_dss: { id: 'chennai_flood_monitor_dss', name: 'CFM-DSS Realtime — Water Level/FRL + ECMWF/IMD AWS (TN Govt)', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  india_flood_inventory_1985_2016: { id: 'india_flood_inventory_1985_2016', name: 'India Flood Inventory 1985-2016 — HydroSense IITD + IMD DWE + EM-DAT/DFO', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  chennai_floods_2005_extent: { id: 'chennai_floods_2005_extent', name: 'Chennai Flood Extent 2005 — GCC SDSS KML', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  chennai_floods_2020_nivar: { id: 'chennai_floods_2020_nivar', name: 'Chennai Floods 2020 Cyclone Nivar — Hotspots KML', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  chennai_lost_waterbodies_2025: { id: 'chennai_lost_waterbodies_2025', name: 'Lost Water Bodies Counterfactual — ScienceDirect 2025 Pallikaranai', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  chennai_highres_topo_2026: { id: 'chennai_highres_topo_2026', name: 'High-Res Topo Anna Univ/HEC-HMS/MIKE FLOOD 2005/2015 validated (Springer 2026)', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  chennai_vulnerability_ann_rf_2025: { id: 'chennai_vulnerability_ann_rf_2025', name: 'Flood Vulnerability ANN/RF — Nature Scientific Reports 2025 280 sites 12 params', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  landsat_7_8_chennai: { id: 'landsat_7_8_chennai', name: 'LANDSAT 7 & 8 — Drainage direction & built-up 2000-2022 (NASA)', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  alos_palsar_chennai: { id: 'alos_palsar_chennai', name: 'ALOS PALSAR — Drainage方向 (ASF Alaska) Chennai', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  chennai_swd_stormwater_drain: { id: 'chennai_swd_stormwater_drain', name: 'Stormwater Drain SWD Maps — GCC (OpenCity)', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  google_open_buildings_chennai: { id: 'google_open_buildings_chennai', name: 'Google Open Buildings — 1.8 B footprints Chennai clip', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  chennai_slums_locations: { id: 'chennai_slums_locations', name: 'Slum Locations — GCC (OpenCity) (TNSCB)', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  smartcities_property_tax_chennai: { id: 'smartcities_property_tax_chennai', name: 'Property Tax Collections — SmartCities (Chennai)', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  gcc_budget_capital_2022_23: { id: 'gcc_budget_capital_2022_23', name: 'GCC Budget Capital Expenditure 2022-23 — Zone-wise (Chennai Corp)', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  water_consumption_capacity_zone: { id: 'water_consumption_capacity_zone', name: 'Water Consumption vs Capacity — Zone deficit (CMWSSB)', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  osm_in_flood_map_live: { id: 'osm_in_flood_map_live', name: 'OSM-in Crowdsourced Inundated Roads — Live (openstreetmap.in)', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  chennai_flood_vulnerability_abhi: { id: 'chennai_flood_vulnerability_abhi', name: 'Flood Vulnerability INDEX — abhi-git06 GEE/ML (GitHub)', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  chennai_floodmapping_ml_shivani: { id: 'chennai_floodmapping_ml_shivani', name: 'Ward-level Flood Risk ML — shivanijwork (GitHub)', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  india_reservoir_live_wris: { id: 'india_reservoir_live_wris', name: 'India Reservoir Live Storage — WRIS/CWC (4 Chennai + 140 national)', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  cityfinance_chennai_budget: { id: 'cityfinance_chennai_budget', name: 'CityFinance Tamil Nadu Chennai Budget 2022-23 (10,907/sqkm)', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
  chennai_arcgis_dashboard: { id: 'chennai_arcgis_dashboard', name: 'ArcGIS Flood Dashboard — 325 schools/health centers inundation (Esri)', category: 'reference', format: 'geojson', crs: 'EPSG:4326', bounds: { xmin: 80.10, xmax: 80.35, ymin: 12.88, ymax: 13.25 }, geometryType: 'Polygon' },
