  ...
  useEffect(() => {
    ...
    const handleCanvasClick = (e: MouseEvent) => {
      ...
      if (intersects.length > 0) {
        ...
        if (obj === ctx.terrain) {
          onSelectObject?.({
            name: `Terrain Cell (${((pt.x / 14 + 0.5) * (CHENNAI_BOUNDS.xmax - CHENNAI_BOUNDS.xmin) + CHENNAI_BOUNDS.xmin).toFixed(4)}degE, ${((pt.z / 14 + 0.5) * (CHENNAI_BOUNDS.ymax - CHENNAI_BOUNDS.ymin) + CHENNAI_BOUNDS.ymin).toFixed(4)}degN)`,
